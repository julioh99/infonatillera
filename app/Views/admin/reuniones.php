            ...
            <form action="/admin/reuniones/crear" method="POST">
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="monto_premio_extra" id="new_monto_premio_extra" class="form-control money-input text-warning fw-bold" inputmode="numeric" pattern="[0-9]*" value="0">
                    </div>
                </div>
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-pill" data-bs-dismiss="modal">Cancelar</button>
