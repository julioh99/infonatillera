                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="monto_inyectado" id="iny_monto_inyectado" class="form-control money-input fw-bold text-success fs-5" inputmode="numeric" placeholder="Ej: 1.000.000" required>
                        </div>
